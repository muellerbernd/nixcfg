let
  systems = {
    ...
    biltower = "biltower ssh-ed25519 AAAAC3NzaC1lZDI1NTE5AAAAIJAt7MEJjzVNUPs5KIkE55lw6+Ss6n9EEspuUQJsZm3J";
  };
  users = {
...
in
{
  ...
  "distributedBuilderKey.age".publicKeys = allUsers ++ [ systems.biltower systems.t480 ];
}
