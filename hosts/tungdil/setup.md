...
```bash
curl https://raw.githubusercontent.com/muellerbernd/nixcfg/refs/heads/main/hosts/tungdil/disk-config.nix -o /tmp/disk-config.nix
...
nixos-install --root /mnt --flake /mnt/etc/nixos#tungdil
nixos-enter
# do some setup
exit
reboot
